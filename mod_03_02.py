...
def send_email(message, recipient, *, sender = "university.help@gmail.com"):
    ...
    # Проверяем если строки recipient и sender не содержит "@" или не оканчивается на ".com"/".ru"/".net"
    ...
    # Если sender и recipient совпадают, то вывести "Нельзя отправить письмо самому себе!"
    if sender == recipient:
        return print('Нельзя отправить письмо самому себе!')

    # Если отправитель не совпадает с university.help@gmail.com
